...
export const MediaLibrary = () => {
  ...
  const toggleCreateFolderDialog = () => setShowCreateFolderDialog((prev) => !prev);
  ...
  return (
    <Layout>
        ...
        <HeaderLayout
          ...
          primaryAction={
            <Stack horizontal spacing={2}>
              <Button startIcon={<Plus />} variant="secondary" onClick={toggleCreateFolderDialog}>
                {formatMessage({
      ...
      {showCreateFolderDialog && <CreateFolderDialog onClose={toggleCreateFolderDialog} />}
